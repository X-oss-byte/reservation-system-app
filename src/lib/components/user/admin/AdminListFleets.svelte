...
<section>
	<div class=" max-w-screen-xl mx-auto px-4 pb-28 gap-12 text-gray-600 md:px-8">
		...
		<ul class="mt-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
			<button
				on:click={() => {
					goto('/admin/fleet/new');
				}}
				class="bg-gray-200 justify-center shadow-md border rounded-lg hover:bg-gray-200"
			>
				<div class="h-full flex self-center justify-center p-4">
					<div class="flex justify-center justify-items-center space-y-2 justify-self-center">
						<h4 class="flex items-center text-gray-600 font-semibold">Add fleet</h4>
					</div>
				</div>
			</button>
