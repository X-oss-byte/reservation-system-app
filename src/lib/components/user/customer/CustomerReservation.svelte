...
<section class="">
	<div class="max-w-screen-xl mx-auto pt-14 px-4 md:px-8">
		<h2 class="text-4xl text-gray-800 font-extrabold mx-auto md:text-5xl mb-10 text-center">
			<span>Review of your reservations</span>
		</h2>
					...
					>
						...
						<div class="text-center my-1">
							<h2 class="font-md text-gray-500 text-xl sm:text-xl">
								{reservationData.fleet.name}
							</h2>
						</div>

						<div class="text-center mb-5">
							<h2 class="font-bold text-black text-xl">{reservationData.item.name}</h2>
						</div>
						<div class="text-center my-1 mb-10">
							<h2 class="text-blue-400 text-xl">
								<a href="tel:{reservationData.item.phone} "> {reservationData.item.phone}</a>
							</h2>
						</div>
